...
//  Constants
//-----------------------------------------------------------------------------
var ZeroVolume = 0.0353147; // 1 liter in ft3
...
//=============================================================================
// double tStep
function qualrout_execute(tStep)
//
...
function getMixedQual(c, v1, wIn, qIn, tStep)
//
...
//=============================================================================
// int i, double tStep
function findLinkMassFlow(i, tStep)
//
//  Input:   i = link index
//           tStep = time step (sec)
//  Output:  none
...
function  findSFLinkQual(i, qSeep, fEvap, tStep)
//
//  Input:   i = link index
//           tStep = routing time step (sec)
//  Output:  none
...
//=============================================================================
// int j, double tStep
function  findStorageQual(j, tStep)
//
//  Input:   j = node index
//           tStep = routing time step (sec)
//  Output:  none
...
function updateHRT(j, v, q, tStep)
//
//  Input:   j = node index
...
function getReactedQual(p, c, v1, tStep)
//
