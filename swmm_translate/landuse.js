...
function  landuse_readParams(j, tok, ntoks)
//
...
//=============================================================================
// int j, char* tok[], int ntoks
function  landuse_readPollutParams(j, tok, ntoks)
//
...
function  landuse_readBuildupParams(tok, ntoks)
//
...
//=============================================================================
//  char* tok[], int ntoks
function  landuse_readWashoffParams(tok, ntoks)
//
//  Input:   tok[] = array of string tokens
//           ntoks = number of tokens
//  Output:  returns an error code
...
function  landuse_getInitBuildup(landFactor, initBuildup,
		 area, curb)
//
...
//      double tStep
function  landuse_getBuildup(i, p, area, curb, buildup,
                            tStep)
//
...
function landuse_getBuildupDays(i, p, buildup)
//
//  Input:   i = land use index
//           p = pollutant index
...
function landuse_getBuildupMass(i, p, days)
//
//  Input:   i = land use index
//           p = pollutant index
...
//=============================================================================
// int j, int p
function landuse_getAvgBmpEffic(j, p)
//
...
function landuse_getWashoffLoad(i, p, area,
...
//     double area
function landuse_getWashoffQual(i, p, buildup, runoff,
                               area)
//
//  Input:   i = land use index
//           p = pollutant index
...
function landuse_getCoPollutLoad(p, washoff)
//
...
function landuse_getExternalBuildup(i, p, buildup, tStep)
//
