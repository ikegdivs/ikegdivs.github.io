...
//  Constants   
//-----------------------------------------------------------------------------
var MAX_RUNOFF_BALANCE_ERR = 10.0;
var MAX_FLOW_BALANCE_ERR   = 10.0;
...
*/
var  RunoffTotals = new TRunoffTotals();    // overall surface runoff continuity totals
var  LoadingTotals = [];   // overall WQ washoff continuity totals
var  GwaterTotals = new TGwaterTotals();    // overall groundwater continuity totals 
var  FlowTotals = new TRoutingTotals();      // overall routed flow continuity totals 
var  QualTotals = [];      // overall routed WQ continuity totals 
var  StepFlowTotals = new TRoutingTotals();  // routed flow totals over time step
var  OldStepFlowTotals = new TRoutingTotals();
var  StepQualTotals = [];  // routed WQ totals over time step

//-----------------------------------------------------------------------------
//  Exportable variables
//-----------------------------------------------------------------------------
var  NodeInflow = [];              // total inflow volume to each node (ft3)
var  NodeOutflow = [];             // total outflow volume from each node (ft3)
var  TotalArea;               // total drainage area (ft2)
...
function massbal_updateRunoffTotals(flowType, v)
//
...
function massbal_updateGwaterTotals(vInfil, vUpperEvap, vLowerEvap,
                             vLowerPerc,  vGwater)
//
...
function massbal_initTimeStepTotals()
//
//  Input:   none
//  Output:  none
...
//=============================================================================
// int type, double q
function massbal_addInflowFlow(type, q)
//
...
function massbal_updateLoadingTotals(type, p, w)
//
//  Input:   type = type of inflow
//           p    = pollutant index
//           w    = mass loading
...
//=============================================================================
// int type, int p, double w
function massbal_addInflowQual(type, p, w)
//
//  Input:   type = type of inflow
//           p    = pollutant index
...
function massbal_addOutflowFlow(q, isFlooded)
//
...
function massbal_addOutflowQual(p, w, isFlooded)
//
//  Input:   p = pollutant index
...
//=============================================================================
// int p, double w
function massbal_addReactedMass(p, w)
//
//  Input:   p = pollutant index
...
//=============================================================================
// int p, double w
function massbal_addSeepageLoss(p, w)
//
//  Input:   p = pollutant index
...
//=============================================================================
// int p, double w
function massbal_addToFinalStorage(p, w)
//
//  Input:   p = pollutant index
//           w = pollutant mass
//  Output:  none
...
function massbal_addNodeLosses(evapLoss, seepLoss)
//
...
//=============================================================================
// double evapLoss, double seepLoss
function massbal_addLinkLosses(evapLoss, seepLoss)
//
...
//=============================================================================
// double tStep
function massbal_updateRoutingTotals(tStep)
//
...
//=============================================================================
// char isFinalStorage
function massbal_getStorage(isFinalStorage)
//
...
function massbal_getSysFlows(f, sysFlows)
//
...
function massbal_getRunoffError()
//
//  Input:   none
//  Output:  none
...
function massbal_getLoadingError()
//
//  Input:   none
//  Output:  none
...
function massbal_getGwaterError()
//
//  Input:   none
//  Output:  none
...
function massbal_getStepFlowError()
//
//  Input:   none
...
//=============================================================================
// int p
function massbal_getStoredMass(p)
//
//  Input:   p = pollutant index
