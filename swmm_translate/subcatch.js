...
// Constants 
//-----------------------------------------------------------------------------
var MCOEFF    = 1.49;              // constant in Manning Eq.
var MEXP      = 1.6666667;         // exponent in Manning Eq.
var ODETOL    = 0.0001;            // acceptable error for ODE solver
...
var Vinflow;       // non-LID precip + snowmelt + runon + ponded water
var Voutflow;      // non-LID runoff to subcatchment's outlet
...
//-----------------------------------------------------------------------------
var  theSubarea;  // TSubarea*   // subarea to which getDdDt() is applied
var    Dstore;         // monthly adjusted depression storage (ft)  //(5.1.013)
var    Alpha;          // monthly adjusted runoff coeff.            //
var RunoffRoutingWords = [ w_OUTLET,  w_IMPERV, w_PERV, null];
...
function  subcatch_readParams(j, tok, ntoks)
//
...
//=============================================================================
// char* tok[], int ntoks
function subcatch_readSubareaParams(tok, ntoks)
//
...
//=============================================================================
// char* tok[], int ntoks
function subcatch_readLanduseParams(tok, ntoks)
//
//  Input:   tok[] = array of string tokens
//           ntoks = number of tokens
//  Output:  returns an error code
...
//=============================================================================
// char* tok[], int ntoks
function subcatch_readInitBuildup(tok, ntoks)
//
//  Input:   tok[] = array of string tokens
//           ntoks = number of tokens
//  Output:  returns an error code
...
//=============================================================================
// int j
function subcatch_setOldState(j)
//
//  Input:   j = subcatchment index
//  Output:  none
...
//=============================================================================
// int j
function subcatch_getFracPerv(j)
//
...
//=============================================================================
// int j
function subcatch_getStorage(j)
//
//  Input:   j = subcatchment index
...
//=============================================================================
// int k, double q
function  subcatch_addRunonFlow(k, q)
//
...
//=============================================================================
// int j, double tStep
function subcatch_getRunoff(j, tStep)
//
//  Input:   j = subcatchment index
//           tStep = time step (sec)
...
//=============================================================================
// int j, double f
function subcatch_getWtdOutflow(j, f)
//
//  Input:   j = subcatchment index
//           f = weighting factor.
...
//    double tStep
function getSubareaRunoff(j, i, area, precip, evap, tStep)
//
...
function findSubareaRunoff(subarea, tRunoff)
//
...
// int i, int j
function adjustSubareaParams(i, j)
//
