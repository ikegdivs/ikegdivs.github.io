...
document.addEventListener("DOMContentLoaded", function(){
    ...
    // Add a legend to the same area.
    createLegend(viz_svg01);
...
function representData(location, theseSpecs){
    ...
    location.attr('viewBox', ` 0 0 ${theseSpecs.xScaleWidth + theseSpecs.legendBuffer + theseSpecs.legendWidth} ${theseSpecs.yScaleHeight}`);
    ...
    function zoomed({transform}) {
        d3.select("#viz_svg01 #chartBody path")
...
function drawLine(theseSpecs, curveType){
    ...
    /////////////////////////////////////////////
    /////////////////////////////////////////////
    /*var mask = d3.selectAll('#chartBody')
        .append("defs")
        .append("clipPath")
        .attr("id", "mask")
        .style("pointer-events", "none")
            ...
            x: 0,
            y: 0,
            width: theseSpecs.xScaleWidth,
            height: theseSpecs.yScaleHeight,
            })
    //Ultimately, to use the above mask to crop the chart, it required calling
        .attr("clip-path", "url(#mask)")

    var masked = d3.selectAll('#chartBody')
        .append("g")
        .attr("clip-path", "url(#mask)")*/
